...
def WifiReadLoop(onIncoming):
    ...
    end_count = 0
    max_anchors, Coordinates, AD_start, AD_end, AD_interval, ID_array, x_array, y_array, distance_array, nos, dcm, reset_dcm, dci = request.getValues(cal_distances)
    print(Coordinates)
    # print(AD_start)
    # print(AD_end)
    # print(AD_interval)
    ...
    while True:
        time.sleep(0.100)
        WiFiString = request.getRequest('/anchors')
                ...
                if 'end' in WiFiString:  # if string contains 'end', stop program when stop with button is used
                    ...
                    try:
                        ...
                        if 'start' in WiFiString and aanstaan == False:
                            ...
                            print(WiFiString)
                            onIncoming(WiFiString, position_y, position_x, wks, x_array, y_array, nos, max_anchors)
                            position_y += 3
                            position_x = 1
