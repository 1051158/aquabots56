import XLS as xls  # Import a module named 'XLS'
...
def calculateDistances(anchor1, anchor2, anchor3, anchor4, coordinates):
    ...
    for i in range(5):
        ...
        d1.append(
            m.sqrt(
                m.pow(anchor1.x - coordinates[i, 0], 2)
                + m.pow(anchor1.y - coordinates[i, 1], 2)
                + m.pow(anchor1.z - coordinates[i, 2], 2)
            )
        )
        d3.append(
            m.sqrt(
                m.pow(anchor3.x - coordinates[i, 0], 2)
                + m.pow(anchor3.y - coordinates[i, 1], 2)
                + m.pow(anchor3.z - coordinates[i, 2], 2)
            )
        )
        d4.append(
            m.sqrt(
                m.pow(anchor4.x - coordinates[i, 0], 2)
                + m.pow(anchor4.y - coordinates[i, 1], 2)
                + m.pow(anchor4.z - coordinates[i, 2], 2)
            )
        )
        d2.append(
            m.sqrt(
                m.pow(anchor2.x - coordinates[i, 0], 2)
                + m.pow(anchor2.y - coordinates[i, 1], 2)
                + m.pow(anchor2.z - coordinates[i, 2], 2)
            )
        )
    print(d1, d2, d3, d4)
    return d1, d2, d3, d4
