...
def WifiReadLoop():
    ...
    tagInfo, Coordinates, x_array, y_array, z_array, distance_array = request.getValues(
        cal_distances
    )

    # Array
    functionNameArray = np.array(
        [
            "setup",
            "newRange",
            "Rdy2Send",
            "checkMenus",
            "checkForDistances",
            "setDistanceIfRegisteredAnchor",
            "generateDistanceAndTimer",
            "synchornizeAnchors",
            "resetAnchors",
            "resetAD",
            "addAD",
    ...
    (
        ...
        d3,
        d4,
    ) = settings.allSettings(Coordinates)
    ...
    while True:
        ...
        if Settings.num_of_send_counter > Settings.nos:
            ...
            antenna_delay, wks, Settings, t, t1 = request.callRightServer(
                Coordinates,
                wbk,
                wks,
                distance_array,
